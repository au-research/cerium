...
public class MyceliumRegistryObjectResourceController {
	...
	public ResponseEntity<?> getRegistryObjectGraph(@PathVariable("registryObjectId") String registryObjectId,
		...
		try {
			...
			return ResponseEntity.badRequest().body("Unable to generate Graph for record");
		}
...
//					childrenCount);
			...
			return ResponseEntity.badRequest().body("Error retrieving nested-collection-parents");
		}
